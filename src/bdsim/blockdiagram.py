...
if TYPE_CHECKING:
    ...
    # The autogenerated mixin is large and imports optional dependencies for
    # rich signatures. In normal runtime we do not need it because @block
    # decorator registration adds real factory methods to BlockDiagram.
    # Keep eager import as an opt-in escape hatch only.
    _eager_mixin = os.getenv("BDSIM_EAGER_BLOCKDIAGRAM_MIXIN", "").strip().lower() in {
        "1",
        "true",
        "yes",
        "on",
    ...
    if _eager_mixin:
        try:
            ...
            # If the generated mixin is unavailable, keep runtime importable;
        ...
        # need to import the large autogenerated mixin module.
        class BlockDiagramMixin:  # type: ignore[no-redef]
            pass
