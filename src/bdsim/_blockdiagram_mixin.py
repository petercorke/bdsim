...
class BlockDiagramMixin:
    ...
    def ARMPLOT(self, robot=None, q0=None, backend=None, **blockargs) -> Any:
        """
    ...
    def BICYCLE(self, L=1, speed_max=inf, accel_max=inf, steer_max=1.413716694115407, x0=None, **blockargs) -> Any:
        """
    ...
    def CIRCLEPATH(self, radius=1, centre=(0, 0, 0), pose=None, frequency=1, unit='rps', phase=0, **blockargs) -> Any:
        """
    ...
    def CLIP(self, min: 'ArrayLike' = -inf, max: 'ArrayLike' = inf, **blockargs) -> Any:
        """
    ...
    def CONSTANT(self, value=0, **blockargs) -> Any:
        """
    ...
    def CTRAJ(self, T1, T2, T, trapezoidal=True, **blockargs) -> Any:
        """
    ...
    def DELTA2TR(self, **blockargs) -> Any:
        """
        :param blockargs: |BlockOptions|
        :type blockargs: dict
        """
    ...
    def DIFFSTEER(self, w=1, R=1, speed_max=inf, accel_max=inf, steer_max=None, a=0, x0=None, **blockargs) -> Any:
        """
    ...
    def FDYN(self, robot, q0=None, **blockargs) -> Any:
        """
        :param robot: Robot model
        :type robot: Robot subclass
    ...
    def FDYN_X(self, robot, q0=None, gravcomp=False, velcomp=False, representation='rpy/xyz', **blockargs) -> Any:
        """
        :param robot: Robot model
        :type robot: Robot subclass
        :param q0: Initial joint configuration
    ...
    def FKINE(self, robot=None, args={}, **blockargs) -> Any:
        """
    ...
    def GRAVLOAD(self, robot, gravity=None, **blockargs) -> Any:
        """
        :param robot: Robot model
        :type robot: Robot subclass
    ...
    def GRAVLOAD_X(self, robot, representation='rpy/xyz', gravity=None, **blockargs) -> Any:
        """
        :param robot: Robot model
        :type robot: Robot subclass
        :param representation: task-space representation, defaults to "rpy/xyz"
    ...
    def IDYN(self, robot, gravity=None, **blockargs) -> Any:
        """
        :param robot: Robot model
        :type robot: Robot subclass
        :param gravity: gravitational acceleration
    ...
    def IKINE(self, robot=None, q0=None, useprevious=True, ik=None, args={}, seed=None, **blockargs) -> Any:
        """
        :param robot: Robot model, defaults to None
        :type robot: Robot subclass, optional
        :param q0: Initial joint angles, defaults to None
    ...
    def INERTIA(self, robot, **blockargs) -> Any:
        """
        :param robot: Robot model
        :type robot: Robot subclass
        :param blockargs: |BlockOptions|
    ...
    def INERTIA_X(self, robot, representation='rpy/xyz', pinv=False, **blockargs) -> Any:
        """
        :param robot: Robot model
        :type robot: Robot subclass
        :param representation: task-space representation, defaults to "rpy/xyz"
    ...
    def JACOBIAN(self, robot, frame='0', representation=None, inverse=False, pinv=False, damping=None, transpose=False, **blockargs) -> Any:
        """
        :param robot: Robot model
        :type robot: Robot subclass
    ...
    def JTRAJ(self, q0, qf, qd0=None, qdf=None, T=None, **blockargs) -> Any:
        """
    ...
    def MULTIROTOR(self, model, groundcheck=True, speedcheck=True, x0=None, **blockargs) -> Any:
        """
    ...
    def MULTIROTORMIXER(self, model=None, wmax=1000, wmin=5, **blockargs) -> Any:
        """
        :param model: A dictionary of vehicle geometric and inertial properties
        :type model: dict
    ...
    def MULTIROTORPLOT(self, model, scale=[-2, 2, -2, 2, 10], flapscale=1, projection='ortho', **blockargs) -> Any:
        """
        :param model: A dictionary of vehicle geometric and inertial properties
        :type model: dict
    ...
    def PIECEWISE(self, *args, seq=None, **blockargs) -> Any:
        """
    ...
    def POINT2TR(self, T=None, **blockargs) -> Any:
        """
    ...
    def SCOPE(self, nin=1, vector: Union[NoneType, int, list[int]] = None, styles=None, stairs=False, scale: Union[Literal['auto'], float] = 'auto', labels=None, grid=True, watch=False, title: Optional[str] = None, loc='best', **blockargs) -> Any:
        """
    ...
    def TR2DELTA(self, **blockargs) -> Any:
        """
        :param blockargs: |BlockOptions|
        :type blockargs: dict
        """
    ...
    def TRAJ(self, y0=0, yf=1, T=None, time=False, traj='trapezoidal', **blockargs) -> Any:
        """
    ...
    def TRAPEZOIDAL(self, q0, qf, V=None, T=None, **blockargs) -> Any:
        """
    ...
    def UNICYCLE(self, w=1, speed_max=inf, accel_max=inf, steer_max=inf, x0=None, **blockargs) -> Any:
        """
    ...
    def VEHICLEPLOT(self, animation=None, path=None, labels=['X', 'Y'], square=True, init=None, scale='auto', polyargs={}, **blockargs) -> Any:
        """
